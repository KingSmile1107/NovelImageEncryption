...
def jiami(img):
    ...
    N0 = 1000
    sine_tent_cosine_map_x0 = logistic_map(x01, r01, N0 + 3 * m * n)[N0:]
    ...
    N01 = 1000
    # chebyshev_tent_map_x0 = logistic_map(x0, u0, N01 + m * 8 * 3)[N01:]
    # chebyshev_tent_map_x1 = logistic_map(x1, u1, N01 + n * 8 * 3)[N01:]
    # chebyshev_tent_map_x2 = logistic_map(x2, u2, N01 + m * n)[N01:]
    #
